...
public class Test_ListImplementations {
     ...
     * @param list The List created from the class
     */
    private static void test03_Remove_From_List(
                    String className, ListADT<String> list)
    {
            // Name of test
            String name = new Object(){}.getClass().getEnclosingMethod().getName();
     ...
     * @param list The List created from the class
     */
    private static void test04_Use_List_Iterator(
                    String className, ListADT<String> list)
    {
            // Name of test
            String name = new Object(){}.getClass().getEnclosingMethod().getName();
     ...
     * @param list The List created from the class
     */
    private static void test05_Check_Java_Generics(
                    String className, ListADT<String> list)
    {
            // Name of the test
            String name = new Object(){}.getClass().getEnclosingMethod().getName();
